...
def main(args):
    ...
    n_hidden = [args.n_hidden_units or N_PARAM] * args.n_hidden
...
if __name__ == "__main__":
    ...
    parser.add_argument('-b', '--batch-shape', type=int, nargs=2, default=[10, 512])
    ...
    parser.add_argument('-nhu', '--n-hidden-units', type=int, default=None)
